...
if __name__ == "__main__":
    use_auth_token = "TOKEN"  # replace "xxx" with your access token (see https://huggingface.co/docs/hub/security-tokens and https://huggingface.co/settings/tokens)

    repo_id = "meta-llama/Llama-2-7b-hf"
    local_dir = "LOCAL_DIR"  # replace "xxx" with a real path and make sure that it has at least 3G of space
    print("start ")
